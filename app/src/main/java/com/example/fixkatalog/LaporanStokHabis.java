...
public class LaporanStokHabis extends AppCompatActivity {

    TextView bulanTahunSH,totalBarangSH;

    RecyclerView recyclerLapStokHabis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lap_stok_habis);

/////
        btnPrintSH = findViewById(R.id.btnPrintSH);
        ...
        btnPrintSH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btnPrintSH.setVisibility(View.GONE);

                takeScreenShot();

                btnPrintSH.setVisibility(View.VISIBLE);
            }
        });
        ////

        Dataref= FirebaseDatabase.getInstance().getReference().child("tampil");
        bulanTahunSH=findViewById(R.id.bulanTahunSH);
        totalBarangSH=findViewById(R.id.totalBarangSH);
        recyclerLapStokHabis=findViewById(R.id.recyclerLapStokHabis);

        recyclerLapStokHabis.setLayoutManager(new LinearLayoutManager(getApplicationContext()));


        Query query=Dataref.orderByChild("jumlahbarang").equalTo("0");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        totalBarangSH.setText(" : "+String.valueOf(count)+" pcs");
                    }else{
                        totalBarangSH.setText("0");
                    }
        ...
        bulanTahunSH.setText(finalTanggal);
    ...
    private void LoadData() {
        ...
        recyclerLapStokHabis.setAdapter(adapter);
